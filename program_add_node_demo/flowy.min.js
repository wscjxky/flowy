    ...
    flowy.load = function() {
        ...
        flowy.beginDrag = function(event) {
            ...
            if (event.which != 3 && event.target.closest(".create-flowy")) {
                ...
                // console.log('ddd', drag)
                // console.log(newNode)
            }
        }

        flowy.endDrag = function(event) {
            // console.log('endnDrag', drag.getBoundingClientRect(), $(event))
            // 
        ...
        function checkAttach(id) {
            ...
            // console.log(xpos >= blocks.filter(a => a.id == id)[0].x - (blocks.filter(a => a.id == id)[0].width / 2) - paddingx, xpos <= blocks.filter(a => a.id == id)[0].x + (blocks.filter(a => a.id == id)[0].width / 2) + paddingx, ypos >= blocks.filter(a => a.id == id)[0].y - (blocks.filter(a => a.id == id)[0].height / 2), ypos <= blocks.filter(a => a.id == id)[0].y + blocks.filter(a => a.id == id)[0].height)
        ...
        //     view: window,
        // });
        // $('.blockelem.create-flowy.noselect')[0].dispatchEvent(evt);
        ...
        // // 中间
        // drag.style.left = '900px'
        // drag.style.top = '150px'
        ...
        // $('.blockelem.create-flowy.noselect')[0].dispatchEvent(evt);
        // drag.style.left = blocks[3].x + offset_x + "px"
        // drag.style.top = blocks[3].y + offset_y + "px"
        // $('#canvas')[0].dispatchEvent(evt1);



        // $('.blockelem.create-flowy.noselect')[0].dispatchEvent(evt);
        // drag.style.left = blocks[4].x + offset_x + "px"
        // drag.style.top = blocks[4].y + offset_y + "px"
        // $('#canvas')[0].dispatchEvent(evt1);

        // $('.blockelem.create-flowy.noselect')[0].dispatchEvent(evt);
        // drag.style.left = blocks[0].x + offset_x + "px"
        // drag.style.top = blocks[0].y + offset_y + "px"
        // $('#canvas')[0].dispatchEvent(evt1);
